...
const api = {
  ...
  openDiagnosticFolder: () => safeInvoke("open-diagnostic-folder"),
  openFileReview: () => safeInvoke("open-file-review"),
  installUpdate: (targetVersion) => safeInvoke("install-update", targetVersion),
  cancelUpdateInstall: () => safeInvoke("cancel-update-install"),

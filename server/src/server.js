...
const apiLimiter = rateLimit({
  ...
  max: 600, // Shared private deployment: allow multiple open dashboards
...
// Middleware
app.use(cors({ exposedHeaders: ["X-Next-Cursor"] }));
